    ...
    let prover_input = ProverInput {
        ...
        memory: Memory {
            ...
            address_to_id: [
                ...
                (19, EncodedMemoryValueId(0)),
                (20, EncodedMemoryValueId(0)),
                (21, EncodedMemoryValueId(0)),
                (22, EncodedMemoryValueId(0)),
                (23, EncodedMemoryValueId(0)),
                (24, EncodedMemoryValueId(0)),
                (25, EncodedMemoryValueId(0)),
                (26, EncodedMemoryValueId(0)),
                (27, EncodedMemoryValueId(0)),
                (28, EncodedMemoryValueId(0)),
                (29, EncodedMemoryValueId(0)),
                (30, EncodedMemoryValueId(0)),
                (31, EncodedMemoryValueId(0)),
                (32, EncodedMemoryValueId(0)),
                (33, EncodedMemoryValueId(0)),
                (34, EncodedMemoryValueId(0)),
            ]
            .into_iter()
            .collect(),
